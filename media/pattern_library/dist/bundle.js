    ...
    var e = {
            ...
            384: (e) => {
                ...
                const w = '[a-zA-Z]\\w*',
                    ...
                    I = { scope: 'number', begin: k, relevance: 0 },
                    z = {
                        begin: /(?=\/[^/\n]*\/)/,
                        contains: [
                            {
                    ...
                    C = { scope: 'title', begin: _, relevance: 0 };
                var H = Object.freeze({
                    __proto__: null,
                ...
                const K = (e, t) => {
                        ...
                        Object.keys(e).forEach((t) => {
                            ...
                            (e.begin = f(n.beforeMatch, g(n.begin))),
                            (e.starts = {
                                relevance: 0,
                ...
                var le = (function (e) {
                    ...
                    function x(e, n, i, o) {
                        ...
                        function d() {
                            if (!j.keywords) return void S.addText(L);
                            let e = 0;
                        ...
                        function h(e, t) {
                            return (
                                e.scope &&
                                    ...
                                    S.openNode(
                                        _.classNameAliases[e.scope] || e.scope
                                    ),
                                e.beginScope &&
                                    (e.beginScope._wrap
                                        ? (S.addKeyword(
                        ...
                        function m(e) {
                            ...
                            j.endScope && j.endScope._wrap
                                ? (u(), S.addKeyword(t, j.endScope._wrap))
                                : j.endScope && j.endScope._multi
                                  ? (u(), g(j.endScope, e))
                                  : o.skip
                                    ? (L += t)
                                    : (o.returnEnd || o.excludeEnd || (L += t),
                                      u(),
                                      o.excludeEnd && (L = t));
                            do {
                                j.scope && S.closeNode(),
                    ...
                    function y(e, n) {
                        ...
                        const o = r.sort((e, t) => {
                                ...
                                if (e.language && t.language) {
                                    if (E(e.language).supersetOf === t.language)
                                        return 1;
                                    if (E(t.language).supersetOf === e.language)
                                        return -1;
                                }
                                return 0;
                            }),
                    ...
                    function w(e) {
                        ...
                        const i = (function (e) {
                            ...
                            return t.split(/\s+/).find((e) => u(e) || E(e));
                        })(e);
                        if (u(i)) return;
                        if (
                    ...
                    function v() {
                        'loading' !== document.readyState
                            ? document
                                  .querySelectorAll(c.cssSelector)
                                  .forEach(w)
                            : (_ = !0);
                    }
                    function E(e) {
                        ...
                        Object.assign(e, {
                            ...
                            highlightBlock: function (e) {
                                return (
                                    ...
                                    Y(
                                        '10.7.0',
                                        'Please use highlightElement now.'
                                    ),
                                    w(e)
                                );
                            },
                ...
                f.registerLanguage('django', m),
                    ...
                    document
                        ...
                        .forEach((e) => {
                            e.addEventListener('click', (e) => {
                                ...
                                for (const t of e.target.closest(
                                    '.js-list-item'
                                ).childNodes)
                                    'UL' === t.nodeName &&
                    ...
                    (function () {
                        ...
                        t.addEventListener('mousedown', function () {
                            ...
                            t.contentWindow.addEventListener('resize', (e) => {
                                document.querySelector(
                                    '.js-iframe-size'
                                ).innerHTML =
                                    `${e.target.innerWidth} x ${e.target.innerHeight}`;
                            }),
                            document.addEventListener('keydown', (t) => {
                                'Escape' === (t = t || window.event).key &&
                                    e.classList.remove('iframe-open');
                            }),
                            n.forEach((e) => {
                                e.addEventListener('click', (e) => {
                                    n.forEach((e) =>
                    ...
                    (function () {
                        const e =
                            document.querySelector('.js-iframe').contentWindow;
                        document.querySelector('.js-iframe-size').innerHTML =
                    ...
                    (function () {
                        ...
                        function n(n) {
                            ...
                            let r = n.target.getAttribute('href');
                            document
                                .querySelector(r)
                                .classList.add('tabbed-content__item--active');
                        }
                    ...
                    (function () {
                        if (location.pathname.includes('/pattern/')) {
                            const e = location.pathname.split('/pattern/')[1],
                    ...
                    (function () {
                        const e = document.getElementById(
                                'js-pattern-search-input'
                            ),
                            t = [
                                ...document.querySelectorAll('.list__item-link')
                            ],
                            n = document.getElementById('sidebar-nav'),
