...
def test_hub_page_get_context_builds_invite_url_from_ref_key(rf):
    ...
    context = hub_page.get_context(rf.get("/invite/?ref_key=TESTABCDEFGHJKM"))
    ...
    expected_code = crypto.referral_id_to_invite_code("TESTABCDEFGHJKM")
    ...
    assert crypto.invite_code_to_referral_id(expected_code) == "TESTABCDEFGHJKM"
