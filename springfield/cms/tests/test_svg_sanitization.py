...
<svg xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="40"/></svg>"""
        ...
        with mock.patch("springfield.cms.fields.filter_svg", side_effect=ValueError("Invalid SVG structure")):
            result = self.field._sanitize_svg(svg_file)
    ...
    def test_py_svg_hush_parse_error_returns_error(self):
        ...
        with mock.patch("springfield.cms.fields.filter_svg", side_effect=ET.ParseError("XML parse failed")):
            result = self.field._sanitize_svg(svg_file)
...
<svg xmlns="http://www.w3.org/2000/svg">
    ...
    def test_sanitizer_writes_back_to_file(self):
        ...
        with mock.patch("springfield.cms.fields.filter_svg", return_value=sentinel):
            result = self.field._sanitize_svg(svg_file)
        self.assertIsNone(result)
