...
def get_carousel_test_page() -> FreeFormPage2026:
    ...
    page.docs = (
        "<p>The Carousel block displays a swipeable horizontal sequence of slides, each with media, heading, and supporting content. "
        ...
        "<p>Avoid putting critical CTAs inside carousel slides &mdash; users often skip past them. Limit slides to 3&ndash;6; longer "
