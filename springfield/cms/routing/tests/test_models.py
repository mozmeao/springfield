...
#
# The rejection half of this guard is exercised where the consumer lives, in
# test_wnp_integration.py: the guard duck-types the consumer's own
# ``is_routing_canonical`` hook, so a page type that does not define it is
# deliberately unaffected — which is what the positive case below asserts.
# ---------------------------------------------------------------------------
