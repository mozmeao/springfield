...
urlpatterns = (
    ...
    path("download/all-form/", views.firefox_all_form, name="firefox.all_form"),
    path("download/all-form/result/", views.firefox_all_form_result, name="firefox.all_form.result"),
