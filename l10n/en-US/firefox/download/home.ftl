...
firefox-home-block-ad-trackers = Block ad trackers without lifting a paw
firefox-home-ad-trackers-make = Not-fun fact: Ad trackers make web pages load slower. Fun fact: You won’t have to dig around in settings to fix that, because { -brand-name-firefox } automatically blocks most trackers.
