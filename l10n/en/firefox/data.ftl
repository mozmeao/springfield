...
### URL: https://www-dev.springfield.moz.works/user-privacy/

# HTML page title

data-page-title = How { -brand-name-firefox } Protects Your Data
...
data-interested-in = Interested in the details? Read on.

# Sidebar menu in-page anchor links

data-privacy-online = Privacy Online
data-tracking-protection = Tracking Protection
data-control-your-data = Control Your Data
...
# Variables
#   $attrs (attrs) - https://firefox-source-docs.mozilla.org/contributing/data-collection.html
data-unlike-other-browsers = Unlike many other browsers where sensitive user data is routinely collected and stored, { -brand-name-firefox } is built on the <a { $attrs }>principle</a> that not even { -brand-name-mozilla } should know which websites you visit or what you do there.
data-for-example-when-you-sync = For example, when you sync your history or bookmarks, { -brand-name-firefox } has to send data to { -brand-name-mozilla } servers so you can seamlessly access them across devices. The difference is, we use end-to-end encryption before it leaves your device, so even we can’t see what sites you’re visiting.
...
# link to https://support.mozilla.org/kb/enhanced-tracking-protection-firefox-desktop
data-more-about-enhanced = More about Enhanced Tracking Protection
...
data-firefox-is-built = { -brand-name-firefox } is built to protect you.
data-take-control = Take control of your data with { -brand-name-firefox } today.

# Firefox browser only: links to about:preferences#privacy
data-manage-your = Manage Your Privacy Settings

# link to https://www.mozilla.org/privacy/firefox/
data-read-the = Read the { -brand-name-firefox } Privacy Notice
