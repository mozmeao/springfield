...
firefox-browsers-windows = { -brand-name-firefox } for Windows
firefox-browsers-mac = { -brand-name-firefox } for Mac
firefox-browsers-linux = { -brand-name-firefox } for Linux
