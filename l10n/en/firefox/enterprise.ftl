...
firefox-enterprise-support-for-organizations-documentation = Support for Organizations documentation
firefox-enterprise-support-for-organizations-is = Support for Organizations is a dedicated offering for teams who need private issue triage and escalation, defined response times, custom development options, and close collaboration with { -brand-name-mozilla }’s engineering and product teams.
