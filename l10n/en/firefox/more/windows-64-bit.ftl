...
# HTML page title
windows-64-bit-firefox-for-windows = { -brand-name-firefox } for Windows 64-bit

# HTML page description
windows-64-bit-users-on-64-bit-windows = Users on 64-bit Windows who download { -brand-name-firefox } can get our 64-bit version by default. That means you get a more secure version of { -brand-name-firefox }.
...
windows-64-bit-users-on-64-bit-windows-crashes = Users on 64-bit Windows who download { -brand-name-firefox } can get our 64-bit version by default. That means you get a more secure version of { -brand-name-firefox }, one that also <a href="{ $crashes }">crashes a whole lot less</a>. How much less? In our tests so far, 64-bit { -brand-name-firefox } reduced crashes by 39% on machines with 4GB of RAM or more.
...
windows-64-bit-if-youre-running = If you’re running 64-bit Windows (<a href="{ $version }">here’s how to check</a>), your { -brand-name-firefox } may already be 64-bit. <a href="{ $check }">Check your { -brand-name-firefox } version</a> (in the “About { -brand-name-firefox }” window) and look for “(32-bit)” or “(64-bit)” after the version number:
...
windows-64-bit-if-you-need-to-run = If you need to run 32-bit { -brand-name-firefox } or manually install 64-bit { -brand-name-firefox }, you can simply download and re-run the Windows (32-bit or 64-bit) { -brand-name-firefox } installer from the <a href="{ $all }">{ -brand-name-firefox } platforms and languages download page.</a>
