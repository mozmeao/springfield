...
you-can-easily = You can easily download the { -brand-name-firefox } desktop browser <a href="{ $url }">here.</a> { -brand-name-firefox } works on <a href="{ $url2 }">Windows,</a> <a href="{ $url3 }">{ -brand-name-mac-short }</a> and <a href="{ $url4 }">{ -brand-name-linux}</a> devices, and is also available for <a href="{ $url5 }">Android and iOS.</a> Make sure you’re downloading our browser from one of our trusted { -brand-name-mozilla }/{ -brand-name-firefox } pages.
...
is-chrome-better = Is Chrome better than { -brand-name-firefox }?
no-we-dont = No, we don’t think Chrome is better than { -brand-name-firefox }, and here is why: when people ask which browser is better, they’re really asking which browser is faster and safer. { -brand-name-firefox } is updated monthly to make sure you have the speediest browser that respects your privacy automatically.

# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/browsers/compare/chrome/

see-how-firefox = <a href="{ $url }">See how { -brand-name-firefox } compares Chrome.</a>

related-questions-better = Related questions: is { -brand-name-firefox } better than Chrome, is { -brand-name-firefox } better than Google, is { -brand-name-firefox } safer than Chrome, is { -brand-name-firefox } more private than Chrome
...
is-firefox-chromium = Is { -brand-name-firefox } Chromium based?
firefox-is-not = { -brand-name-firefox } is not based on Chromium (the open source browser project at the core of Google Chrome). In fact, we’re one of the last major browsers that isn’t. { -brand-name-firefox } runs on our Quantum browser engine built specifically for { -brand-name-firefox }, so we can ensure your data is handled respectfully and kept private.

does-firefox-use = Does { -brand-name-firefox } use Google?

# Variables:
# $url (url) - link to https://support.mozilla.org/kb/change-your-default-search-settings-firefox

firefoxs-default-search = Google is the default search engine in { -brand-name-firefox }, which means you can search the web directly from the address bar. <a href="{ $url }">Learn more about search engine preferences and changing defaults.</a>
...
related-questions-who = Related questions: who is { -brand-name-firefox } owned by, who owns { -brand-name-firefox-browser }, is { -brand-name-firefox } owned by Google, is { -brand-name-mozilla } { -brand-name-firefox } owned by Google
